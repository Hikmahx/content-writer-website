        ...
        <div className='flex flex-col lg:flex-row gap-16 items-center'>
          <div className='relative flex justify-center lg:justify-start lg:flex-1'>
            ...
            <div className='flex flex-col space-y-4 max-w-md sm:max-w-2xl lg:max-w-4xl'>
              ...
              <span className='text-black font-medium'> website copy</span>, and
              <span className='text-black font-medium'> brand stories</span> that build
              trust and inspire action.
              </p>

              <p className='text-sm lg:text-base text-gray-600 leading-[1.9] lg:leading-relaxed mt-4'>
              I specialize in{' '}
              <span className='text-black font-medium'>SEO-driven content strategies</span>{' '}
              ...
              <span className='text-black font-medium'> rigorous research</span> to deliver
              on-brand, on-time content that aligns with your voice and
              goals—driving
              <span className='text-black font-medium'> readability</span>,
              <span className='text-black font-medium'> rankings</span>, and a stronger
