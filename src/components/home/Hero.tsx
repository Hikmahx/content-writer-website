...
export function Hero() {
  return (
    <section className='relative xl:[clip-path:inset(0_0_80px_0)] xl:-mb-[80px] overflow-hidden flex flex-col-reverse md:flex-col md:grid md:grid-cols-2 2xl:max-w-7xl mx-auto md:items-center mb-12 md:mb-0'>
